...
internal static class UnderWaterMotorPatch
{
    ...
    private static IEnumerable<CodeInstruction> UpdateMoveTranspiler(IEnumerable<CodeInstruction> instructions, ILGenerator ilGen)
    {
        ...
        newInstructions1.Add(new CodeInstruction(OpCodes.Call, AccessTools.PropertyGetter(typeof(PlayerMotorPatch), "ApplySlippery")));
